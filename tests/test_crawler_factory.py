...
class TestCrawlerFactory:
    ...
    def setup_crawler_factory(self, mock_crawlers_service, sample_crawlers):
        ...
        mock_crawlers_service.get_active_crawlers.return_value = sample_crawlers
    ...
    def test_initialize(self, setup_crawler_factory, sample_crawlers, monkeypatch):
        ...
        # 執行初始化
        CrawlerFactory.initialize(mock_service)
    ...
    def test_initialize_exception(self, setup_crawler_factory):
        """測試初始化過程中的異常處理"""
        mock_service = setup_crawler_factory
    ...
    def test_get_crawler(self, setup_crawler_factory, monkeypatch):
        """測試獲取爬蟲實例功能"""
        mock_service = setup_crawler_factory
        ...
        # 驗證爬蟲類別是否被正確實例化
        mock_crawler_class.assert_called_once_with(config_file_name="test_config.json")
    ...
    def test_get_crawler_not_found(self, setup_crawler_factory, monkeypatch):
        """測試獲取不存在的爬蟲實例"""
        mock_service = setup_crawler_factory
    ...
    def test_list_available_crawlers(self, setup_crawler_factory, monkeypatch):
        """測試列出可用爬蟲功能"""
        mock_service = setup_crawler_factory
