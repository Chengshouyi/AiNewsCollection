...
def mock_crawlers_service(monkeypatch, sample_crawlers):
    ...
    monkeypatch.setattr('src.web.routes.crawler.get_crawlers_service', lambda: mock_service)
    return mock_service
...
def mock_handle_api_error(monkeypatch):
    ...
    monkeypatch.setattr('src.web.routes.crawler.handle_api_error', mock_error_handler)
