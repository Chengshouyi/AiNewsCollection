...
class CrawlerTasksCreateSchema(BaseCreateSchema):
    ...
    def validate_required_fields(cls, data):
        ...
        if isinstance(data, dict):
            required_fields = ['task_name', 'crawler_id', 'task_args', 'ai_only']
...
class CrawlerTasksUpdateSchema(BaseUpdateSchema):
    ...
    def get_updated_fields(cls):
        return ['task_name', 'is_auto', 'ai_only', 'task_args', 'notes', 'last_run_at', 'last_run_success', 'last_run_message', 'cron_expression'] + BaseUpdateSchema.get_updated_fields()
